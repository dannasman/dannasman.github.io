...
In El1 we set up the `spsr_el1` the same way as in the other ELs. We also set all interrupt mask\\
bits to 1. In addition to these steps one could also set up exception tables at this point.
