...
And there we have it! The MMU should be now set up and you should be able to execute code residing in address spaces `0x40000000-0x3fffffff` and `0xffff000040000000-0xffff00003fffffff`.
